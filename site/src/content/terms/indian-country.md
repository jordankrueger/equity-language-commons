...
Indian Country is a legal term of art with a popular second life, and the corpus's advice is to know which one you're using. The Indigenous Journalists Association and the Diversity Style Guide give near-identical two-part definitions: Indian Country is first a [Title 18 U.S. Code term](https://www.law.cornell.edu/uscode/text/18/1151) that defines federal and tribal jurisdiction in crimes affecting American Indians on reservations, and second a popular usage covering reservations and areas with Native populations. IJA adds "lands held within tribal jurisdictions" to that popular sense. The Native Governance Center adds the orthographic rule, capitalize Indian Country, alongside its reminder that a reservation (a federally defined land base) is not the same thing as a Native nation (a sovereign political entity).
