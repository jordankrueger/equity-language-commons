...
guidance:
  - org: "Global Consortium for Journalism & Trauma"
    ...
    derived_from: []
    quote: "Be careful when referring broadly to mental illness or \"serious mental illness\" in reporting. In general, refer to a specific condition where possible. Do not refer to a particular condition unless it's relevant and has been formally diagnosed."
    quote_loc: "\"Mental Illness\" entry"
    paraphrase: "GCJT cautions against broad references to \"mental illness,\" urging writers to name a specific condition only when it is relevant and formally diagnosed, to use people-first language, and not to conflate mental illness with violence."
  ...
  - org: "Diversity Style Guide"
    ...
    year: 2023
    entry_updated: null
    source_url: "https://www.diversitystyleguide.com/glossary/mental-illness-mental-health-disorder/"
    local_archive: "source-guides/discovered/diversity-style-guide-2023-11.md"
    recommendation: "use-with-care"
    derived_from: []
    quote: "Recognize that the terms mental illness and mental health disorder cover a wide range of conditions, and, whenever possible, the specific diagnosis for an individual should be used rather than the blanket term. … Always refer to someone with a mental illness as a person first."
    quote_loc: "Glossary entry, \"mental illness, mental health disorder\""
    paraphrase: "The Diversity Style Guide accepts \"mental illness\" as a broad term but presses for the specific diagnosis where possible, people-first construction, referencing the condition only when relevant and properly sourced, and notes some advocates want to retire the term entirely."
    confidence: "VERIFIED-ARCHIVED"
context_data: []
external_references: []
