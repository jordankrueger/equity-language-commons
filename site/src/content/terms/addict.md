...
guidance:
  ...
  - org: "American Psychological Association"
    ...
    recommendation: "avoid"
    derived_from: []
    quote: "Term to avoid: addict. Suggested alternatives: person who injects drugs / person with substance use disorder."
    quote_loc: "Disability/health terms table, \"Term to Avoid / Suggested Alternative\""
    paraphrase: "APA's term-to-avoid table lists \"addict\" (alongside \"alcoholic\" and \"drug user/abuser\"), prescribing the person-first \"person with substance use disorder\" or \"person who injects drugs\" instead."
    confidence: "VERIFIED-ARCHIVED"
