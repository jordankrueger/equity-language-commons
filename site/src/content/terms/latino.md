...
audience_notes:
  ...
  - audience: "Latina (feminine)"
    note: "Use specifically for women and women-only groups (Sierra Club, SEIU explicit). Latina is the right form for an individual woman who identifies as Latina; Latino is the right form for an individual man who identifies as Latino. Do not default to Latina for unknown-gender individuals."
