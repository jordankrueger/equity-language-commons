...
guidance:
  - org: "SumOfUs"
    ...
    recommendation: "use"
    derived_from: []
    quote: "Ageism is a system of beliefs, attitudes, and actions, fueled by institutional power, that oppresses all people at all ages, but is considered most detrimental for the physical health of our oldest citizens. Ageists view a person's age number or chronological age as a marker of essential characteristics or type."
    quote_loc: "\"Anti-ageism framework\""
    paraphrase: "SumOfUs builds its age guidance around an anti-ageism framework, defining ageism as a system of beliefs, attitudes, and actions fueled by institutional power that oppresses people at every age. It treats ageism as language communicators should recognize and name."
  ...
  - org: "Diversity Style Guide"
    ...
    year: 2023
    entry_updated: null
    source_url: "https://www.diversitystyleguide.com/glossary/ageism/"
...
**"Ageism" is the word to use, not avoid — it is this chapter's structural concept, the parallel to [ableism](/terms/ableism/), [classism](/terms/classism/), racism, and sexism.** All five sources define it the same way and prescribe it as standard vocabulary. The lineage is unusually explicit: GCJT and the Diversity Style Guide both trace the term to Robert N. Butler's 1969 coinage, and Butler built the parallel into the definition itself — ageism does to age "just as racism and sexism accomplish with skin color and gender." APA, SumOfUs, and Sierra Club carry the same three-part structure: prejudicial attitudes, discriminatory practices, and institutional policies that perpetuate stereotypes.

The one distinction worth keeping visible is that ageism runs in both directions. APA defines it as discrimination based on age "regardless of whether the targeted individual or group is younger or older," and Sierra Club spells out both poles — older people facing workplace discrimination (the most commonly understood form) and young people treated as less than full members of a community. SumOfUs frames it most expansively, as a system that oppresses "all people at all ages." This bi-directionality is what separates ageism from the age descriptors it sits beside: [elderly](/terms/elderly/) and [aging](/terms/aging/) are about how to refer to older people, while ageism names the structure that makes those word choices matter.

The guidance is stable from SumOfUs (2016) through APA (2023), refining rather than revising. As with classism, the practical wrinkle is familiarity — ageism is less reflexively recognized than racism or sexism, so the sources tend to define it on use rather than assume it.
