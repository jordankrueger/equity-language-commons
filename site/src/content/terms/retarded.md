...
guidance:
  - org: "SumOfUs"
    ...
    derived_from: []
    quote: "Terms avoided/questioned by disability rights activists: … psycho … retarded … schizo … schizophrenic (never use to mean \"of two minds\")"
    quote_loc: "Disability language two-column list, \"Terms avoided/questioned by disability rights activists\""
    paraphrase: "SumOfUs lists \"retarded\" among the terms avoided or questioned by disability rights activists, contrasting them with person-first forms such as \"person who has [a condition].\""
  ...
  - org: "Diversity Style Guide"
    ...
    year: 2023
    entry_updated: null
    source_url: "https://www.diversitystyleguide.com/glossary/mentally-retarded-mentally-disabled-intellectually-disabled-developmentally-disabled/"
...
The law moved with the language. In 2010, Rosa's Law replaced "mental retardation" with "intellectual disability" across much of U.S. federal statute — both NCDJ and the Diversity Style Guide cite it. That shift marks the clinical term's retirement, not merely a stylistic preference.
