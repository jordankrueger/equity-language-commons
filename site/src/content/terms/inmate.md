...
**"Inmate" is mostly an avoid — but it is the one term in this chapter with genuine dissent.** Color of Change, Sierra Club, and the Diversity Style Guide all pair "inmate" (avoid) against "incarcerated person" (use), with DSG again routing through The Marshall Project's people-first constructions. GCJT lands at use-with-care, advising writers to ask the individual's preference. The outlier is SumOfUs, which — drawing on a 2016 reader survey — places "inmate" in the column of "terms used by … incarceration reform activists," a genuine use.
