...
guidance:
  ...
  - org: "Diversity Style Guide"
    ...
    year: 2023
    entry_updated: null
    source_url: "https://www.diversitystyleguide.com/glossary/homophobia/"
...
The corpus is unified on the **concept** and split on the **application.** Every source accepts homophobia as a real and useful concept — Sierra Club, Color of Change, DSG, HRC, and NLGJA all use it without scare quotes or hedging. HRC's definition sets the floor: "the fear and hatred of or discomfort with people who are attracted to members of the same sex." The "discomfort" inclusion matters: homophobia in the corpus is treated as a spectrum from overt hostility through ambient discomfort, not requiring active animus to qualify. Color of Change extends the frame, positioning homophobia as one of three interlocking systems alongside sexism and transphobia.

Where the corpus converges sharply is on a **journalistic restriction**: don't call individual people "homophobes" in news copy. DSG and NLGJA give nearly identical guidance — "Use LGBTQ+ rights opponents or a similar phrase instead of homophobes when describing people who oppose LGBTQ+ people, rights or activism." The reasoning is about precision and verifiability rather than softening: "homophobe" labels a person's internal state (fear, hatred), which is hard to prove and easy to dispute, while "LGBTQ+ rights opponents" names the verifiable position. Both guides restrict "homophobia" itself to relevant usage — quotations, opinion writing, or broad references to the concept — rather than barring it from news copy entirely. Sierra Club takes a more activist position: name homophobic *patterns in writing* (jokes that rely on the implication that male politicians are in a sexual relationship) as homophobia even when no slur appears. The writer-side accountability frame is unusual in this corpus and worth noting.

The corpus also treats **biphobia and transphobia as a related family.** NLGJA names them as parallel formations of homophobia; HRC's biphobia entry mirrors the homophobia definition exactly. The "-phobia" suffix is criticized in some adjacent scholarship as inaccurate (these aren't phobias in the clinical sense, they're systemic prejudices), but the in-corpus guides retain the formations as standard usage — none of the eight sources scanned offers an alternative like "heterosexism" or "anti-gay prejudice" as a replacement. APA and academic guides sometimes do; the in-scope corpus does not.

The chronology is short and consistent: **post-2020 LGBTQ+-led journalism guides converge on "restrict to relevant usage and don't label people."** That convergence is settled and operational. The older progressive guides (SumOfUs 2016, SEIU 2020) don't engage homophobia as a labeled topic; the post-2020 set engages it but tightens the application.
