...
The agreement extends to mechanics: it's an adjective ("a nonbinary person," not "a nonbinary"), it takes singular "they" unless the person specifies otherwise, and it's lowercase except at the start of a sentence. The only real variation across sources is spelling — the closed "nonbinary" is now dominant, with hyphenated "non-binary" still appearing in some entries. As always, an individual's own term governs. Pairs with [gender identity](/terms/gender-identity/) and [transgender](/terms/transgender/).

## Audience notes

- **Journalists and editors.** "Nonbinary" is the standard term; use singular "they" by default and confirm. It's an adjective — don't write "a nonbinary."
