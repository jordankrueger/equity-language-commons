...
Two practical cautions recur. First, gender identity is distinct from sexual orientation (who a person is attracted to) and from gender expression (how they present). The corpus keeps these three axes separate, and conflating them is a frequent error. Second, GCJT's relevance rule: "only refer to an individual's gender identity" when it actually matters to the story, rather than as gratuitous detail. This page pairs with [cisgender](/terms/cisgender/), [transgender](/terms/transgender/), and [pronouns](/terms/pronouns/).
