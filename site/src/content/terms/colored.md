...
guidance:
  - org: "SEIU"
    ...
    entry_updated: null
    source_url: null
    local_archive: "source-guides/seiu-stylebook-2020-01.md"
  ...
  - org: "American Psychological Association"
    ...
    recommendation: "avoid"
    derived_from: []
    quote: "The terms “Negro,” “colored,” and “Afro-American” are outdated, and their use is generally inappropriate…"
    quote_loc: "African American/Black entry"
    paraphrase: "Within its African American/Black guidance, APA groups \"colored\" with \"Negro\" and \"Afro-American\" as terms it advises against, directing writers to \"Black\" instead."
    confidence: "VERIFIED-ARCHIVED"
  - org: "Diversity Style Guide"
    org_slug: "diversity-style-guide"
    year: 2023
    entry_updated: null
    source_url: "https://www.diversitystyleguide.com/glossary/colored/"
...
audience_notes:
  ...
  - audience: "International context"
    note: "In parts of southern Africa, \"Coloured\" is a distinct, recognized identity for people of mixed ancestry (notably in South Africa). NABJ and DSG both flag this. The avoid-guidance here is about U.S. usage; the regional identity is a separate matter and should follow local self-identification."
...
The contrast that does the teaching is with that newer term. "Colored people" and "people of color" describe an overlapping group, but one is a label that earlier usage attached to people and the other is a frame people chose for themselves. SEIU's pairing draws the line directly, prescribing "persons of color" in the same breath that it bans "colored persons." The practical rule for a communicator is simple: keep "colored" only inside its three exceptions, and use "Black" or "people of color" everywhere else.
