...
guidance:
  ...
  - org: "American Psychological Association"
    ...
    recommendation: "avoid"
    derived_from: []
    quote: "suffers from or is afflicted with [condition]"
    quote_loc: "Terms to Avoid table, disability section"
    paraphrase: "APA lists \"suffers from\" and \"is afflicted with [condition]\" in its terms-to-avoid table, pairing them with neutral, person-first alternatives. The guidance treats the suffering and affliction frame as an assumption about a person's experience that the writer should not impose."
    confidence: "VERIFIED-ARCHIVED"
