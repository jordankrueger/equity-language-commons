...
**Every source in the corpus says avoid "illegal immigrant."** This is one of the chapter's clearest agreements, and two arguments recur across the guides. The first is logical and ethical: a person cannot be illegal. SumOfUs makes the point by analogy — calling someone an "illegal immigrant" makes as much sense as calling an accused accountant an "illegal accountant." The Diversity Style Guide puts it structurally: the term "criminalizes the person rather than the actual act," and lays down a hard rule, "never use illegal(s) as a noun." The second argument is practical: the term flattens a complex legal reality and has been widely abandoned by newsrooms, as both the Immigrant Defense Project guides state. (Sierra Club registers the rejection more briefly, placing the term on an avoid list; Color of Change frames it through people-first language.)
